...
class neural_network:
    def __init__(self, train_set, train_label, test_set, test_label, nb_input, nb_output, nb_hidden, nb_neuron):
...
net = neural_network(train_set, train_label, test_set, test_label,2,2,1,3)
net.sequential(Layer(2,3))
