...
\newcolumntype{B}{>{\columncolor{LimeGreen!50!white}}m{3.5cm}}
\newcolumntype{C}{>{\columncolor{LimeGreen!50!white}}m{6cm}}
\newcolumntype{D}{>{\columncolor{LimeGreen!50!white}}m{7cm}}
\newcolumntype{E}{>{\columncolor{LimeGreen}}m{3cm}}
\newcolumntype{F}{>{\columncolor{Red!50!white}}m{6cm}}
\newcolumntype{G}{>{\columncolor{Red!50!white}}m{3cm}}
\newcolumntype{H}{>{\columncolor{Yellow!50!white}}m{0.5cm}}
...
\tikzstyle{block} 		= [draw, fill={rgb:red,0;green,0.447;blue,0.7410;white,3}, rectangle, minimum height=1cm, minimum width=1.5cm, node distance=1.5cm]
