...
An improvement to this framework would be to implement a more optimized gradient descent with matrix multiplication. Indeed, it would speed up things in case of batch size greater than 1, because the backward pass could take as input the loss in batch instead of input by input.