...
The final error rate for the ReLu neural network with the test set is $5.8\%$, and is $2.2\%$ with the TanH neural network. With the chosen parameters, TanH neural network have better result.